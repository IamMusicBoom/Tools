package com.wma.wmalib.toast_utils;
...
public class ToastManager {
    ...
    @SuppressLint("InflateParams")
    private void createToast(Context mContext, int msg, int showTime,
                             int gravity, int xOffset, int yOffset) {
        if (toast == null) {
            toast = Toast.makeText(mContext, msg, showTime);
    ...
    public void show(String info, int showTime) {
        createCenterToast(BaseAppContext.getInstance(), info, showTime);
    }

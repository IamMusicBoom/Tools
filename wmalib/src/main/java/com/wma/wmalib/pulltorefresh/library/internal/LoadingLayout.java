...
import com.wma.wmalib.pulltorefresh.library.ILoadingLayout;
import com.wma.wmalib.pulltorefresh.library.PullToRefreshBase.Mode;
import com.wma.wmalib.pulltorefresh.library.PullToRefreshBase.Orientation;
...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
    ...
    protected RelativeLayout fl_left;
    ...
    public LoadingLayout(Context context, final Mode mode, final Orientation scrollDirection, TypedArray attrs) {
        ...
        fl_left = (RelativeLayout) findViewById(R.id.fl_left);
    ...
    private String getLastUpdateTime() {
        ...
        long diffTime = new Date().getTime() - lastRefreshTime;
